...
int main()
{
  ...
  */
  ...
  std::cout << "f("<<n<<") = " << recursive << " (recursive)" << std::endl
            << "\tDuration: " << std::chrono::duration_cast<std::chrono::microseconds>(rec_end - rec_start).count() << " microseconds"
            << " (ca. " << std::chrono::duration_cast<std::chrono::seconds>(rec_end - rec_start).count() << " seconds and "
            << std::chrono::duration_cast<std::chrono::milliseconds>(rec_end - rec_start).count() % 1000 << " milliseconds)"
            << std::endl;
